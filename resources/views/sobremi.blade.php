...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="logo"><a href="#">Algo mas! <span></span></a></div>
			</header>
			...
			<section id="main">
				...
				<!-- One -->
					<section id="one" class="wrapper style1">
						...
						<div class="content">
							<p>Mi nombre es Natalia Gonzalez, Tengo  años y actualmente soy aprendiz del sena enfocada en analisis y desarrollo de sistemas de información. </p>
